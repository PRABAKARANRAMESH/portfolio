...
const TimelineContainer = styled(Box)(({ theme }) => ({
  ...
  [theme.breakpoints.down('md')]: {
    ...
    '&::before': {
      ...
      bottom: 0,
      width: 3,
      background: 'linear-gradient(180deg, transparent 0%, #a855f7 10%, #06b6d4 50%, #14b8a6 90%, transparent 100%)',
      borderRadius: '2px',
...
const TimelineIcon = styled(Box)(({ theme }) => ({
  ...
  justifyContent: 'center',
  zIndex: 3,
  boxShadow: '0 8px 24px rgba(168, 85, 247, 0.4), 0 0 0 4px rgba(15, 23, 42, 1), 0 0 0 8px rgba(168, 85, 247, 0.2)',
...
const TimelineContent = styled(Box)(({ theme }) => ({
  ...
  '&:hover': {
    ...
    boxShadow: '0 20px 60px rgba(0, 0, 0, 0.4), 0 0 30px rgba(168, 85, 247, 0.3)',
    '&::after': {
      opacity: 1,
    },
  },
  ...
  const educationData = [
    {
      ...
      subjects: ['Tamil','English','Mathematics', 'Science', 'Social Studies' ],
      icon: School,
      showCGPA: false
    },
    {
      ...
      subtitle: 'Science Stream (PCM + Biology)',
      institution: 'Saraswathi Matriculation Higher Secondary School',
      year: '2020 - 2022',
      status: 'Completed',
      description: 'Completed higher secondary education with strong foundation in sciences and mathematics, preparing for engineering entrance examinations.',
    ...
    },
    {
      ...
      year: '2022 - 2026',
      status: 'Current',
      description: 'Pursuing a comprehensive degree with focus on software development, cloud computing, and emerging technologies. Actively engaged in practical projects and research.',
      subjects: ['Web Development', 'Database Management', 'Data Structures & Algorithms', 'Computer Networks', 'Cloud Computing', 'Software Engineering'],
      icon: GraduationCap,
      cgpa: '8.34',
      showCGPA: true
    },
              ...
              <TimelineItem key={education.id}>
                ...
                <TimelineContent className="timeline-content">
                 <Box sx={{
                  ...
                  {education.showCGPA && (
                    <CGPAHighlight>
                      <GraduationCap size={getCalendarIconSize()} />
